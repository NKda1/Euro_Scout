          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {navLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link href={href} className="text-sm font-bold text-slate-600 transition hover:text-red-600 dark:text-slate-300 dark:hover:text-red-400">
                    {label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-sm font-bold text-slate-600 transition hover:text-red-600 dark:text-slate-300 dark:hover:text-red-400"
                >
