                  ...
                  <div className="border border-red-200 bg-gradient-to-br from-red-50 to-white p-4 dark:border-red-500/25 dark:from-red-500/10 dark:to-white/[0.02]">
                    ...
                    {!recipientOnline && (
                      <p className="mt-1.5 text-[10px] font-semibold text-slate-400 dark:text-white/30">
                        {presenceStatus === "recovering" ? "Presence is reconnecting — the call notification will still be delivered" : `${counterpartName} must be online. Schedule a time below instead.`}
                      </p>
                    )}
                  </div>
